...
|----|-------|--------|-------------|------|
| 2510.13363 | D-SMART: Enhancing LLM Dialogue Consistency via Dynamic Stru | **FULL** (deep-recard) | yes (shallow→deep) | BATCH20 |
| 2510.23010 | TALM: Dynamic Tree-Structured Multi-Agent Framework with Lon | **FULL** (deep-recard) | yes (shallow→deep) | BATCH20 |
| 2511.01633 | Scaling Graph Chain-of-Thought Reasoning: A Multi-Agent Fram | **FULL** (deep-recard) | yes (shallow→deep) | BATCH20 |
...
| 2512.16962 | MemoryGraft: Persistent Compromise of LLM Agents via Poisone | **FULL** (deep-recard) | yes (shallow→deep) | BATCH20 |
| 2601.03192 | MemRL: Self-Evolving Agents via Runtime Reinforcement Learni | **FULL** (deep-recard) | yes (shallow→deep) | BATCH20 |
