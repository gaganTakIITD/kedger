...
| 36 | `1809.09600` | HotpotQA | FULL | 1 (eval/failure) | hydrate_retrieve | no |
| 37 | `2002.08909` | REALM — retrieval-augmented LM pre-training | FULL | 1 (eval/failure) | hydrate_retrieve | yes |
| 38 | `2004.12832` | ColBERT — late interaction dense retrieval | FULL | 1 (eval/failure) | hydrate_retrieve | yes |
| 39 | `2011.01060` | 2WikiMultiHopQA | FULL | 1 (eval/failure) | hydrate_retrieve | no |
| 40 | `2208.03299` | Atlas — retrieval augmented few-shot LM | FULL | 1 (eval/failure) | hydrate_retrieve | yes |
| 41 | `2212.10509` | IRCoT — interleaved retrieval + CoT | FULL | 1 (eval/failure) | hydrate_retrieve | yes |
| 42 | `2301.12652` | REPLUG — retrieval-augmented black-box LMs | FULL | 1 (eval/failure) | hydrate_retrieve | yes |
| 43 | `2303.16634` | G-Eval — GPT-4 NLG evaluation with CoT rubrics | FULL | 1 (eval/failure) | hydrate_retrieve | yes |
| 44 | `2305.06983` | FLARE / Active Retrieval Augmented Generation | FULL | 1 (eval/failure) | hydrate_retrieve | yes |
| 45 | `2305.13300` | Adaptive Chameleon (knowledge conflicts) | FULL | 1 (eval/failure) | hydrate_retrieve | yes |
| 46 | `2307.03172` | Lost in the Middle | FULL | 1 (eval/failure) | episode_cognify,hydrate_retrieve | no |
| 47 | `2307.13854` | WebArena | FULL | 1 (eval/failure) | hydrate_retrieve | no |
| 48 | `2308.03688` | AgentBench | FULL | 1 (eval/failure) | hydrate_retrieve | yes |
| 49 | `2308.14508` | LongBench | FULL | 1 (eval/failure) | hydrate_retrieve | yes |
| 50 | `2309.01431` | RGB (RAG Benchmark) | FULL | 1 (eval/failure) | hydrate_retrieve | yes |
...
| 428 | `2411.01705` | RAG backdoor data extraction | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 429 | `2501.06322` | Multi-Agent Collaboration Mechanisms survey | FULL | 6 (eng-judgment) | conflict_compose | no |
| 430 | `2501.12948` | Additional fetched fulltexts used as supporting | FULL | 6 (eng-judgment) | anchors_graph,conflict_compose | no |
| 431 | `2502.00306` | Stealthy MIA for RAG (Riddle Me This) | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 432 | `2502.00592` | M+ — scalable long-term MemoryLLM | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 433 | `2502.12110` | A-MEM | FULL | 6 (eng-judgment) | episode_cognify,anchors_graph,conflict_compose | no |
| 434 | `2503.03704` | MINJA (query-only memory injection) | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 435 | `2503.08026` | RMM — Reflective Memory Management | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 436 | `2503.18813` | Additional fetched fulltexts used as supporting | FULL | 6 (eng-judgment) | anchors_graph,conflict_compose | no |
| 437 | `2503.21760` | MemInsight — autonomous memory augmentation | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 438 | `2504.11703` | Progent (privilege control) | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 439 | `2504.13169` | REVERSE — generate but verify | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 440 | `2504.13171` | Sleep-time Compute | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 441 | `2504.15965` | From Human Memory to AI Memory survey | FULL | 6 (eng-judgment) | anchors_graph | no |
| 442 | `2504.18070` | PropRAG | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 443 | `2505.00675` | Additional fetched fulltexts used as supporting | FULL | 6 (eng-judgment) | anchors_graph,conflict_compose | no |
| 444 | `2505.02099` | MemEngine — modular memory library | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 445 | `2505.19549` | Multi-granularity conversational memory (MemGAS) | FULL | 6 (eng-judgment) | episode_cognify,anchors_graph | no |
| 446 | `2505.23052` | RAGRouter — RAG-aware query routing | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 447 | `2505.23841` | SkewRoute — training-free KG-RAG LLM routing | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 448 | `2505.24478` | Cognee / KG–LLM interface optimization | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 449 | `2506.15841` | MEM1 (constant-size IS memory) | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 450 | `2507.02259` | MemAgent | FULL | 6 (eng-judgment) | episode_cognify | no |
| 451 | `2507.03724` | MemOS | FULL | 6 (eng-judgment) | capture_working,episode_cognify | no |
| 452 | `2507.06229` | Agent KB (cross-framework experience) | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 453 | `2507.07957` | MIRIX — multi-agent memory system | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 454 | `2507.10457` | LPCI — logic-layer prompt control injection | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 455 | `2508.04903` | RCR-Router | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 456 | `2508.06433` | Memp — agent procedural memory | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 457 | `2508.08997` | Intrinsic Memory Agents — heterogeneous MAS memory | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 458 | `2508.09736` | M3-Agent — multimodal long-term memory | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 459 | `2508.16153` | Memento (case-based M-MDP memory) | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 460 | `2508.19828` | Memory-R1 | FULL | 6 (eng-judgment) | episode_cognify,anchors_graph,conflict_compose | no |
| 461 | `2509.13313` | ReSum — context summarization for search agents | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 462 | `2509.24704` | MemGen — generative latent memory | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 463 | `2509.25140` | ReasoningBank + MaTTS | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 464 | `2509.25911` | Mem-α | FULL | 6 (eng-judgment) | episode_cognify,anchors_graph,conflict_compose | no |
| 465 | `2510.04851` | LEGOMem (modular procedural multi-agent) | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 466 | `2510.05244` | IPI Firewalls (Minimizer + Sanitizer) | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 467 | `2510.06719` | DP Synthetic Text for RAG | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 468 | `2510.08558` | Agent learning via early experience | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 469 | `2510.10397` | AssoMem | FULL | 6 (eng-judgment) | anchors_graph,conflict_compose | no |
| 470 | `2510.11967` | Context-Folding — branch/return context management | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 471 | `2510.12635` | Memory as Action / MemAct | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 472 | `2510.18866` | LightMem | FULL | 6 (eng-judgment) | episode_cognify,anchors_graph,conflict_compose | no |
| 473 | `2510.24699` | AgentFold — proactive context management | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 474 | `2510.26486` | LINK-KG — coreference-resolved KG construction | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 475 | `2511.00628` | AgentGit — Git-like MAS checkpoints/branching | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 476 | `2511.06449` | FLEX | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 477 | `2511.13593` | O-Mem (omni persona/episodic/working) | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 478 | `2512.10696` | ReMe — dynamic procedural memory | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 479 | `2512.13564` | Memory in the Age of AI Agents (survey) | FULL | 6 (eng-judgment) | anchors_graph,conflict_compose | no |
| 480 | `2512.18950` | Hierarchical procedural memory (Bayesian) | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 481 | `2512.22716` | Memento 2 | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 482 | `2601.05960` | Memory-as-a-Tool | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 483 | `2602.06052` | Agent Memory Second Half survey | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 484 | `2602.19320` | Anatomy of Agentic Memory (survey) | FULL | 6 (eng-judgment) | conflict_compose | no |
| 485 | `2603.02228` | Neural Paging — learned context management | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 486 | `2603.07670` | Memory for Autonomous LLM Agents (survey) | FULL | 6 (eng-judgment) | anchors_graph,conflict_compose | no |
| 487 | `2603.15994` | Selective Memory / supersession chains | FULL | 6 (eng-judgment) | anchors_graph,conflict_compose | no |
| 488 | `2603.24018` | ELITE — experiential learning and intent-aware transfer | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 489 | `2603.24639` | ERL — experiential reflective learning | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 490 | `2604.04853` | MemMachine — ground-truth-preserving agent memory | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 491 | `2604.21748` | StructMem — structured hierarchical memory | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 492 | `2605.06716` | From Storage to Experience (survey) | FULL | 6 (eng-judgment) | anchors_graph | no |
| 493 | `2605.27825` | MRMMIA — membership inference on chat-agent memory | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 494 | `2605.30690` | ElasticMem — latent memory as learnable resource | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 495 | `2606.04425` | Cross-Session Stored Prompt Injection | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 496 | `2606.10525` | Assessing Automated Prompt Injection in Agentic Environments | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 497 | `2606.23127` | Managing procedural memory in LLM agents | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 498 | `2606.29824` | Neural procedural memory for LLM agents | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
| 499 | `2608.03463` | LeanMem — efficient long-term agent memory | FULL | 6 (eng-judgment) | hydrate_retrieve | no |
