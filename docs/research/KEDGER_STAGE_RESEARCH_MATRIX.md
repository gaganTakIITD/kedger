...
| **S8** Why | `why.py` | Provenance after prune; LongMemEval abstention; ConflictRAG dual-view | `why` + workstream ConflictSet for anchor | Chain-of-Note per Evidence still open | done (conflicts in why) |
